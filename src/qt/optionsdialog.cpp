    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new FerretcoinUnits(this));
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Ferretcoin."), QMessageBox::Ok);
